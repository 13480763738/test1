package com.jiudian.p2p.front.servlets.introduce;
...
import com.jiudian.p2p.front.servlets.Register;
import com.jiudian.p2p.front.servlets.m.AEStest;
import com.jiudian.p2p.front.servlets.m.tree.TreeRegister;
...
public class RedPacket extends AbstractFrontServlet {
	...
	protected void onThrowable(HttpServletRequest request,
		...
		if (throwable instanceof LogicalException
			...
			forwardView(request, response, RedPacket.class);
