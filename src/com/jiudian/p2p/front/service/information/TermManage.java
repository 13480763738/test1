...
public abstract interface TermManage extends Service {
	 ...
	 * @param termType
	 *            协议类型
	 * @return {@link Term} 协议信息,不存在则返回{@code null}
	 * @throws Throwable
	 */
	public abstract Term get(TermType termType) throws Throwable;
	 ...
	 * @throws Throwable
	 */
	public abstract String[] getAttachments(TermType termType) throws Throwable;
