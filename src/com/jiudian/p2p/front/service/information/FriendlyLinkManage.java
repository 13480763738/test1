...
public interface FriendlyLinkManage extends Service {
	 ...
	 * 返回结果说明：
	 * <ol>
	 * <li>{@link FriendlyLink#id}对应{@code T5014.F01}</li>
	 * <li>{@link FriendlyLink#name}对应{@code T5014.F04}</li>
	 * <li>{@link FriendlyLink#url}对应{@code T5014.F05}</li>
	 * </ol>
	 * </dl>
	 * </dt>
	 * 
	 * @return {@link FriendlyLink}{@code []} 友情链接列表,没有任何记录则返回{@code null}
	 * @throws Throwable
	 */
	public abstract FriendlyLink[] getAll() throws Throwable;
	 ...
	 * @param id
	 *            友情链接ID
	 * @return {@link FriendlyLink} 友情链接信息,不存在则返回{@code null}
	 * @throws Throwable
	 */
	public abstract FriendlyLink get(int id) throws Throwable;
