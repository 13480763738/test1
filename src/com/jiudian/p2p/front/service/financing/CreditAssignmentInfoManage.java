...
public interface CreditAssignmentInfoManage extends Service {
	 ...
	 * @param id
	 *            转出表ID
	 * @return {@link TenderRecord[]} 投标记录,如果不存在则返回{@code null}
	 * @throws Throwable
	 */
	 ...
	 * @throws Throwable
	 */
	public abstract Xgzl[] getXgzl(int id)throws Throwable;
	 ...
	 * @throws Throwable
	 */
	public abstract String getFkxx(int id)throws Throwable;
