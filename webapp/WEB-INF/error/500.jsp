...
返回<a href="<%if(configureProvider.format(systemDefine.getSiteDomainKey()).indexOf(request.getServerName())>=0){configureProvider.format(out,URLVariable.INDEX);}if(configureProvider.format(systemDefine.getWapDomainKey()).indexOf(request.getServerName())>=0){configureProvider.format(out,URLVariable.WAP_INDEX);}%>" style="color:#00a7e5;"><%configureProvider.format(out,SystemVariable.SITE_NAME);%>首页</a></p>
</div>
</body>
</html>
