...
<body style="background:#f1f3f5;">
    ...
    <form action="<%=controller.getURI(request, Xgmm.class)%>" method="post" onsubmit="return onSubmit()">
    <div class="register_box_hf">
    	...
    	<div class="center" style="position:relative;">
        	<div class="register_hf" style="width:100%; margin-top:50px;">
        		<div class="register_top_hf" style="width:100%; text-align:center; height:80px;">
                	<p class="xgmrma">您的账户当前使用的是系统默认密码，为确保您的账号资金安全，请更改您的登录密码！</p>
                </div>
                <div class="register_center_hf" style="margin-left:240px;min-height:350px;">
