	...
	<div class="center_box">
    	<div class="center">
    		<div class="new_list_box_hf">
    			<div class="new_list_tit_hf"><img src="<%=controller.getStaticPath(request)%>/images/new_images/hlwjryj_tit.jpg"></div>
                <div class="new_list_hf">
                	<ul>
			        	<%
							...
							PagingResult<Article> results = articleManage.search(ArticleType.HLWJRYJ, new Paging() {public int getCurrentPage() {return currentPage;}public int getSize() {return 12;}});
							Article[] articles = results.getItems();
							if (articles != null && articles.length > 0) {
								for (Article article : articles) {
						%>
			            <li><a target="_blank" href="<%=controller.getPagingItemURI(request, Hlwjryj.class,article.id)%>?seo=<%=article.creater%>">
