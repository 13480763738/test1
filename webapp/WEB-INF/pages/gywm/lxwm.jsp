...
<head>
<%
String _TITLE_ = "联系我们 - 关于我们 - "+configureProvider.getProperty(SystemVariable.SITE_NAME);
String _KEYWORDS_ = "";
...
<%@include file="/WEB-INF/include/gywm/left.jsp"%>
	<div class="about about1">
			<%
				...
				Article article = articleManage.get(ArticleType.LXWM);
				if (article != null) {
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=xpFigt6TSyadHX3XKUoEmfEp"></script>
...
<script type="text/javascript" src="<%=controller.getStaticPath(request)%>/js/qltb/baidu.map.js"></script><!--地图js-->
