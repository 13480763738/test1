...
<head>
<%
String _TITLE_ = "管理团队 - 关于我们 - "+configureProvider.getProperty(SystemVariable.SITE_NAME);
String _KEYWORDS_ = "";
...
<%@include file="/WEB-INF/include/gywm/left.jsp"%>
	<div class="about white-bg pt10">
                   <div class="new-about-xian"></div>
		<h1 class="pl20 pr20 pb40">管理团队</h1>
		<ul class="guanli pl20 pr20 pt40">
			<%
			...
			<li>
				<div class="left">
                	...
                	<img src="<%=fileStore.getURL(article.imageCode)%>"/>
					<%}	%>
				</div>
				<%String[] s = article.title.split(";");%>
				<div class="right">
					<p class="header">
						<span class="name"><%StringHelper.filterHTML(out, s[0]);%></span>
						<span><%if (s.length == 2) {StringHelper.filterHTML(out, s[1]);} %></span>
					</p>
					<p class="bottom">
