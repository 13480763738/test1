...
<head>
<%
String _TITLE_ = "企业荣誉 - 关于我们 - "+configureProvider.getProperty(SystemVariable.SITE_NAME);
String _KEYWORDS_ = "";
...
<body>
	...
	<%@include file="/WEB-INF/include/gywm/left.jsp"%>
       		...
       		<%
 				...
 				Article article = articleManage.get(ArticleType.QYZZ);
 				if (article != null) {
