...
<head>
<%
String _TITLE_ = "生意贷 - P2P贷款 - "+configureProvider.getProperty(SystemVariable.SITE_NAME);
String _KEYWORDS_ = "";
...
<body>
	...
	<div class="nav_box">
    	<div class="nav">
        	...
        	<span>
            	<a href="<%configureProvider.format(out,URLVariable.CREDIT_XJD);%>">薪金贷</a>
                <a href="<%configureProvider.format(out,URLVariable.CREDIT_SYD);%>" class="selected">生意贷</a>
            </span>
        </div>
    </div>
        ...
        <div class="center_all_border">
            <div class="center">
                <div class="syd_top_hf">
                    <p><img src="<%=controller.getStaticPath(request)%>/images/new_images/syd.tit.jpg" alt="<%=_ALT%>"><span>( 适用私营企业主 )</span></p>
                    <a href="<%=controller.getViewURI(request,com.jiudian.p2p.front.servlets.p2pdaikuan.syd.Syd.class)%>" class="btn_hf">立即申请</a>
                </div>
            </div>
        </div>
    	<div class="center">
        	<div class="syd_center_hf">
                ...
                <p>&nbsp;</p>
                <p style="padding-left:25px;">•  22-55周岁的中国公民<br/>•  企业经营时间满一年</p>
                <p style="font-size:24px; color:#515151; padding-top:60px;">借款方式</p>
                <p>&nbsp;</p>
                ...
                <em style="padding-left: 56px;"><%=Formater.formatRate(Float.parseFloat(configureProvider.getProperty(SystemVariable.SUCCESS_BMONEY_RATE_AA)))%></em>
                ...
                <em style="padding-left: 47px;"><%=Formater.formatRate(Float.parseFloat(configureProvider.getProperty(SystemVariable.SUCCESS_BMONEY_RATE_C)))%></em>
                <em style="padding-left: 48px;"><%=Formater.formatRate(Float.parseFloat(configureProvider.getProperty(SystemVariable.SUCCESS_BMONEY_RATE_D)))%></em>
                <em style="padding-left: 47px;"><%=Formater.formatRate(Float.parseFloat(configureProvider.getProperty(SystemVariable.SUCCESS_BMONEY_RATE_E)))%></em>
                <em style="padding-left: 49px;"><%=Formater.formatRate(Float.parseFloat(configureProvider.getProperty(SystemVariable.SUCCESS_BMONEY_RATE_HR)))%></em></p>
                ...
                <p style="text-align:center; padding-top:50px; padding-bottom:100px;"><a href="<%=controller.getViewURI(request,com.jiudian.p2p.front.servlets.p2pdaikuan.syd.Syd.class)%>" class="btn_hf">立即申请</a></p>
                <div class="syd_center_right_hf">
                    ...
                    <p style="padding-left:25px;">•&nbsp;&nbsp;&nbsp; 经营证明  <a href="<%=controller.getViewURI(request, Yyzzsl.class)%>" target="_blank"  style="font-size:12px;  padding-left:10px;">查看示例</a></p>
                    <p style="padding-left:50px;">a）通过年检且注册满1年的营业执照</p>
                    <p style="padding-left:50px;">b）经营场地租赁合同＋90天内的租金发票或水电单据</p>
                    <p style="padding-left:25px;">•&nbsp;&nbsp;&nbsp;可体现经营情况的近6个月常用银行卡流水<em style="font-size:12px;">(对公账户或个人账户)</em> <a href="<%=controller.getViewURI(request, Sjsl.class)%>" target="_blank" style="font-size:12px;  padding-left:10px;">查看示例</a></p>
                </div>
            </div>
        </div>
    </div>
