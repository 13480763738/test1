...
<%
	...
	Lmoneysh data =  lmoneyshManage.getLmoneysh(CreditType.SYD.name());
		...
		<div class="contain_main clearfix">
			...
			<div class="borrow_money clearfix">
				...
				<div class="must_info">
					...
					<%
						state = lmoneyManage.getAttentiontype(AttestationType.GSRZ);
						if(state.equals(AttestationState.WYZ)){
					%>
					<dl class="yw_jcxx clearfix">
						<dt class="ico6"></dt>
					...
					%>
					<%
						if(state.equals(AttestationState.YYZ) && !StringHelper.isEmpty(data.isgs) && data.isgs.equals(AttestationStatus.YYZ.name())){
					%>
					<dl class="yw_jcxx clearfix">
						<dt class="ico6"></dt>
						<dt class="ico13"></dt>
					...
					%>
					<%
						if(state.equals(AttestationState.YYZ) && !StringHelper.isEmpty(data.isgssr) && data.isgssr.equals(AttestationStatus.YYZ.name())){
					%>
					<dl class="yw_jcxx clearfix">
						<dt class="ico8"></dt>
						<dt class="ico13"></dt>
				...
				<div class="must_info">
					...
					%>
					<%
						if(state.equals(AttestationState.YYZ) && !StringHelper.isEmpty(data.isgsjszc) && data.isgsjszc.equals(AttestationStatus.YYZ.name())){
					%>
					<dl class="yw_jcxx clearfix">
						<dt class="ico7"></dt>
						<dt class="ico13"></dt>
