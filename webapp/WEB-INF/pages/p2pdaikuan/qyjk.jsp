...
<%@page import="com.jiudian.p2p.front.servlets.p2pdaikuan.Qyjk"%>
...
<body>
	        ...
	        <div class="container">
	            ...
	            <div class="navbar navbar-inverse">
	                <div class="navbar-inner">
	                    <ul class="nav">
	                        <li class="selected"><a href="javascript:viod(0);" >企业借款</a></li>
	                        </ul>
	                </div>
	            </div>
	            <!--end: Navigation -->
	...
	<div class="center_box">
	        ...
	        <form action="<%=controller.getURI(request, Qyjk.class)%>" class="form1" method="post">
        <div class="center">
        	<div class="jkzx_box_hf white-bg">
                ...
                <div class="xxtx_bot_hf">
                    ...
                    <dl>
                        ...
                        <dd><input name="qymc" type="text" class="required max-length-50" />
                        	<p tip></p>
			   				<p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                    <dl>
                    	<dt><span>*</span>经营地址&nbsp;&nbsp;</dt>
                        <dd>
                         <input name="qydz" type="text" class="required max-length-100" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                    <dl>
                    	<dt><span>*</span>企业联系方式&nbsp;&nbsp;</dt>
                        <dd>
                         <input name="qylxfs" type="text" class="required max-length-20" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                        ...
                        <dd><input name="zczb" type="text" class="required mulriple-100" /><em>元</em>
		                 <p tip></p>
					     <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                    	<dt><span>*</span>实收资本&nbsp;&nbsp;</dt>
                        <dd><input name="sszb" type="text" class="required mulriple-100" /><em>元</em>
		                 <p tip></p>
					     <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                    <dl>
                    	<dt><span>*</span>主营业务&nbsp;&nbsp;</dt>
                        <dd>
                         <input name="zyyw" type="text" class="required max-length-255" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd>
                         <input name="yyzz" type="text" class="required max-length-50" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                    	<dt><span>*</span>机构代码证登记号&nbsp;&nbsp;</dt>
                        <dd>
                         <input name="jgdm" type="text" class="required max-length-50" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                    	<dt><span>*</span>税务登记证编号&nbsp;&nbsp;</dt>
                        <dd>
                         <input name="swdj" type="text" class="required max-length-50" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                        ...
                        <dd>
                         <input name="frdb" type="text" class="required max-length-50" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                    	<dt><span>*</span>法人联系方式&nbsp;&nbsp;</dt>
                        <dd>
                         <input name="frlxfs" type="text" class="required max-length-50" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                    	<dt><span>*</span>法人身份证号码&nbsp;&nbsp;</dt>
                        <dd>
                         <input name="sfz" type="text" class="required idcard" />
		                  <p tip></p>
					      <p errortip class="" style="display: none"></p>
                        </dd>
                    </dl>
                     <dl>
                    	<dt><span>*</span>家庭住址&nbsp;&nbsp;</dt>
                        <dd>
