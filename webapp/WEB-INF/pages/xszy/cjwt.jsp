...
<%@include file="/WEB-INF/include/xszy/left.jsp"%>
	...
	<div class="white-bg new-question mt20">
		...
		<div class="wtbox">
		    <h3>4、资金提现需要多长时间到账？</h3>
     		    <p>a借款人还款后，投资人可在当日申请提现，资金到账时间为T+1；</p>
     		    <p>b提现申请提交成功后，预计在下一工作日到账，实际到账时间由提现银行的处理机制而定；</p>
	...
	<div class="white-bg new-question mt20">
		...
		<div class="wtbox">
		    <h3>4、什么样的债权可以转让？</h3>
 		    <p>a债权持有0天后即可进行转让。</p>
     		    <p>b债权没有处于逾期状态。如转让挂出时没有处于逾期，但在转让中时债权变为逾期状态，系统将会把债权停止转让。</p>
     		    <p>c转让预发起时间距离下一个回款日超过3天。</p>
		</div>			
	</div>		
</div>
