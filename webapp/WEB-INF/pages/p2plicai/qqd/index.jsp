...
<div class="content_part2 container" style="height:900px;">
     <p class="f18 dark_gray pl20 pb20">旗企贷列表</p>
     <div class="biaodi">
        ...
        <div class="biaodi_list">
             ...
             <div class="clear"></div>
             <%AbstractFinancingServlet.rendPaging(out, result,controller.getPagingURI(request, com.jiudian.p2p.front.servlets.p2plicai.qqd.Index.class),parameter.getQueryString());%>
        </div> 
		</div>  
    </div>
	</div>          
