...
<%
	...
	URLParameter parameter = new URLParameter(request,controller.getViewURI(request, com.jiudian.p2p.front.servlets.p2plicai.wytz.Index.class),multiSelect,MULTISELECT_KEY,TYPE_KEY,TERM_KEY,LEVEL_KEY);
...
<div class="content_part2 container" style="height:900px;">
     <p class="f18 dark_gray pl20 pb20">全部投资列表</p>
     <div class="biaodi">
        ...
        <div class="biaodi_list">
             ...
             <div class="clear"></div>
             <%AbstractFinancingServlet.rendPaging(out, result,controller.getPagingURI(request, com.jiudian.p2p.front.servlets.p2plicai.wytz.Index.class),parameter.getQueryString());%>
        </div> 
    </div>
	</div>
	</div>
