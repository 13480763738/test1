...
<%
	...
	new InvestQuery() {
		...
		public ProductType getProductType() {
			return EnumParser.parse(ProductType.class, ProductType.QCD.name());
		}
	}, new Paging() {
...
<div class="content_part2 container" style=" background:none; height:900px;">
     <p class="f18 dark_gray pl20 pb20">旗车贷列表</p>
     <div class="biaodi">
        ...
        <div class="biaodi_list">
             ...
             <div class="clear"></div>
             <%AbstractFinancingServlet.rendPaging(out, result,controller.getPagingURI(request, com.jiudian.p2p.front.servlets.p2plicai.qcd.Index.class),parameter.getQueryString());%>
        </div> 
    </div>
</div>          
  </div>
