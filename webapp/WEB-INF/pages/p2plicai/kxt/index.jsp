...
<%
	...
	URLParameter parameter = new URLParameter(request,controller.getViewURI(request, com.jiudian.p2p.front.servlets.p2plicai.kxt.Index.class),multiSelect,MULTISELECT_KEY,TYPE_KEY,TERM_KEY,LEVEL_KEY);
...
<div class="content_part2 container" style=" background:none; height:900px;">
     <div class="h42"></div>
     <p class="f18 dark_gray">供应链贷列表</p>
     <div class="biaodi">
        ...
        <div class="biaodi_list">
             ...
             <div class="clear"></div>
             <%AbstractFinancingServlet.rendPaging(out, result,controller.getPagingURI(request, com.jiudian.p2p.front.servlets.p2plicai.kxt.Index.class),parameter.getQueryString());%>
        </div> 
    </div>
</div>          
