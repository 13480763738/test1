...
<%
	...
	URLParameter parameter = new URLParameter(request,controller.getViewURI(request, com.jiudian.p2p.front.servlets.p2plicai.qsd.Index.class),multiSelect,MULTISELECT_KEY,TYPE_KEY,TERM_KEY,LEVEL_KEY);
	...
	return EnumParser.parse(ProductType.class, ProductType.QSD.name());
		}
	}, new Paging() {
...
<div class="content_part2 container" style=" background:none; height:900px; margin-top:42px;">
     <p class="f18 dark_gray pl20 pb20">旗速贷列表</p>
     <div class="biaodi">
        ...
        <div class="biaodi_list">
        	         ...
        	         <tbody>
        	           ...
        	           <tr class="all_bjs">
        	             <td width="400" height="64">
        	               ...
        	               %>
        	               <a class="title" title="<%StringHelper.filterHTML(out,creditInfo.title);%>" href="<%=controller.getPagingItemURI(request, Bdxq.class,creditInfo.id)%>"><%
             ...
             <div class="clear"></div>
             <%
             	AbstractFinancingServlet.rendPaging(out, result,controller.getPagingURI(request, com.jiudian.p2p.front.servlets.p2plicai.qsd.Index.class),parameter.getQueryString());
             %>
        </div> 
    </div>
</div>          
