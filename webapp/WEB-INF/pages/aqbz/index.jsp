		...
		<div class="new-center white-bg pt20 pb40">
			...
			<ul>
				...
				<li>
					...
					<p>
						所有通过麒麟通宝平台发布的融资需求项目均需通过项目的材料初审、前期背景调查、实地财务核查、实地项目考察、工商司法调查、平台线上审核这六道严格的风控审核，确保平台所有项目均在全面规范的风控下开展。
					</p>
				</li>
				<li>
		...
		<div class="new-center white-bg pt20 pb40">
			...
			<ul>
				<li>
					...
					<p>
						平台自建机房，为平台网站设置多重防火墙，在硬件的日常维护中建立了严格的管理及监控制度。
					</p>
				</li>
				<li>
