...
<!--//
{var a = window.opener||window.parent;while(a.parent!=a){a = a.parent;}if(a.location.host!='<%=configureProvider.format(systemDefine.getSiteDomainKey())%>' && a.location.host!='<%=configureProvider.format(systemDefine.getWapDomainKey())%>'){a.location.href='<%=configureProvider.format(systemDefine.getSiteIndexKey())%>';}}
